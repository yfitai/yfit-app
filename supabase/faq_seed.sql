...
INSERT INTO faq_categories (id, name, description, icon, display_order) VALUES
  ('cat-01-0000-0000-000000000001', 'Getting Started',        'New to YFIT? Start here.',                       '🚀', 1),
  ('cat-02-0000-0000-000000000002', 'Nutrition Tracking',     'Logging food, macros, and meal planning.',       '🥗', 2),
  ('cat-03-0000-0000-000000000003', 'Fitness & Workouts',     'Workout logging, form analysis, and strength.',  '💪', 3),
  ('cat-04-0000-0000-000000000004', 'Goals & Progress',       'Setting goals and tracking your results.',       '🎯', 4),
  ('cat-05-0000-0000-000000000005', 'Medications & Health',   'Medication reminders and health tracking.',      '💊', 5),
  ('cat-06-0000-0000-000000000006', 'AI Coach',               'Using the AI coaching and chat features.',       '🤖', 6),
  ('cat-07-0000-0000-000000000007', 'Account Settings',       'Profile, preferences, and privacy.',             '⚙️', 7),
  ('cat-08-0000-0000-000000000008', 'Subscription & Billing', 'Plans, payments, and upgrades.',                 '💳', 8),
  ('cat-09-0000-0000-000000000009', 'Troubleshooting',        'Fixing common issues and errors.',               '🔧', 9);

-- ============================================================
-- 3. SEED ARTICLES
-- ============================================================

-- ---- GETTING STARTED (cat-01) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-01-0000-0000-000000000001',
...
Once your goals are saved, your Dashboard will show personalised calorie targets and your weekly wellness score will start tracking. You''re all set!',
ARRAY['setup', 'profile', 'first time', 'getting started', 'onboarding'], 1),
...
ARRAY['tracking', 'features', 'what does yfit do', 'overview'], 2),
...
ARRAY['navigation', 'how to use', 'tabs', 'pages', 'menu'], 3),

('cat-01-0000-0000-000000000001',
'Is my data private and secure?',
'Yes. YFIT takes your privacy seriously:

• All data is stored securely in an encrypted database (Supabase/PostgreSQL).
...
ARRAY['privacy', 'security', 'data', 'safe', 'GDPR', 'personal information'], 4),
...
• Web browser — visit the YFIT web app at your account URL on any device
...
ARRAY['web', 'android', 'sync', 'cross platform', 'browser', 'phone'], 5),
...
All measurements throughout the app — including body measurements, weight, and height — will immediately display in your chosen unit system. Your data is always stored in metric internally and converted for display.',
ARRAY['units', 'metric', 'imperial', 'kg', 'lbs', 'cm', 'inches', 'toggle'], 6),
...
ARRAY['beta', 'invite', 'testing', 'early access', 'beta code'], 7),

('cat-01-0000-0000-000000000001',
'How do I log out of YFIT?',
'To log out:

1. Tap the Account Settings icon (⚙️) in the navigation bar.
...
ARRAY['log out', 'sign out', 'logout'], 8),
...
This action is permanent and cannot be undone. All your logs, measurements, workout history, and personal data will be deleted immediately. If you''re having trouble with the app, please try the feedback button first — we''d love to help fix the issue.',
ARRAY['delete account', 'remove account', 'cancel', 'data deletion'], 9),
...
Most users are fully set up within 10 minutes. The more data you log, the more personalised your AI coaching becomes.',
ARRAY['first steps', 'what to do', 'new user', 'start', 'setup guide'], 10);

-- ---- NUTRITION TRACKING (cat-02) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-02-0000-0000-000000000002',
...
ARRAY['log food', 'add meal', 'track food', 'log meal', 'food diary'], 1),
...
ARRAY['barcode', 'scanner', 'scan food', 'camera', 'packaged food'], 2),
...
4. Tap Save. The food is added to your My Foods list for quick access in the future.

Custom foods are saved to your account and will appear in search results when you type the food name.',
ARRAY['custom food', 'add food', 'create food', 'manual entry', 'not in database'], 3),
...
My Foods makes it faster to log foods you eat regularly — they appear at the top of your search results.',
ARRAY['my foods', 'favourites', 'saved foods', 'food library', 'delete food'], 4),
...
3. Tap Save Goals — YFIT calculates your TDEE (Total Daily Energy Expenditure) and sets calorie and macro targets.
...
ARRAY['calorie target', 'macro target', 'TDEE', 'calorie goal', 'protein goal', 'carb goal', 'fat goal'], 5),
...
2. Then it multiplies your BMR by an activity factor based on your selected activity level:
...
Your calorie target is then adjusted based on your goal (deficit for fat loss, surplus for muscle gain, maintenance for recomposition).',
ARRAY['TDEE', 'calories', 'BMR', 'activity level', 'calorie calculation', 'Mifflin'], 6),

('cat-02-0000-0000-000000000002',
'How do I use meal templates?',
'Meal templates let you log a group of foods at once — perfect for meals you eat regularly:

1. Go to Nutrition and tap the Templates tab.
2. Tap Create Template.
3. Name the template (e.g. "My Usual Breakfast").
4. Add foods to the template by searching or scanning.
5. Save the template.

To use a template:
1. Tap + Add Food for any meal.
2. Tap the Templates tab.
3. Select your template and tap Log All Foods.

All foods in the template are added to your meal log in one tap.',
ARRAY['meal template', 'template', 'quick log', 'repeat meal', 'saved meal'], 7),
...
ARRAY['water', 'hydration', 'water intake', 'log water', 'drink'], 8),

('cat-02-0000-0000-000000000002',
'Why are my calories showing differently than expected?',
'If your calorie totals look wrong, check these common causes:

1. Serving size — make sure you selected the correct serving size and quantity when logging. A serving of "100g" vs "1 cup" can be very different.
2. Duplicate entries — you may have logged the same food twice. Scroll through your meal log to check.
3. Database values — nutritional values come from Open Food Facts and the USDA database. Occasionally these may differ slightly from the label on your product. Use the custom food feature to enter exact values from your packaging.
...
ARRAY['calories wrong', 'calorie error', 'incorrect calories', 'nutrition wrong'], 9),
...
ARRAY['edit food', 'delete food', 'remove food', 'change serving', 'fix log'], 10),
...
ARRAY['food database', 'Open Food Facts', 'USDA', 'data source', 'nutritional data'], 11);

-- ---- FITNESS & WORKOUTS (cat-03) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-03-0000-0000-000000000003',
...
Your workout is saved to your history and counts toward your weekly workout total on the Dashboard. Completed strength sessions appear in the Strength Stats tab.',
ARRAY['log workout', 'start workout', 'track workout', 'exercise log'], 1),
...
Form scores are saved to your history and shown in the Fitness Progress tab. Regular form analysis helps prevent injury and maximises training effectiveness.',
ARRAY['form analysis', 'form score', 'technique', 'AI analysis', 'camera', 'posture'], 2),
...
Each exercise includes instructions, muscle group tags, and equipment requirements. You can also add custom exercises if something is missing from the library.',
ARRAY['exercise library', 'exercises', 'workout list', 'muscle groups', 'custom exercise'], 3),
...
Your custom plans appear in the Plans list and can be started with one tap. You can create as many plans as you need.',
ARRAY['workout plan', 'custom plan', 'create plan', 'routine', 'program'], 4),

('cat-03-0000-0000-000000000003',
'What does the Strength Stats tab show?',
'The Strength Stats tab shows your progress for strength training specifically:

• Weekly workout count — number of completed strength sessions this week
• Total volume — total weight lifted (sets × reps × weight) over time
...
Only strength and resistance training sessions are counted here. Cardio, walking, stretching, and yoga sessions are tracked separately.',
ARRAY['strength stats', 'progress', 'personal record', 'volume', 'strength tracking'], 5),
...
Cardio sessions are saved to your workout history. They count toward your total activity but are not included in the Strength Stats count. Your step count from the Daily Tracker also contributes to your overall activity picture.',
ARRAY['cardio', 'running', 'cycling', 'cardio tracking', 'aerobic'], 6),

('cat-03-0000-0000-000000000003',
'How is my workout compliance score calculated?',
...
Your weekly workout count is compared against this 3-session target to contribute to your overall wellness metrics. If you train more or less than 3 times per week, you can discuss adjusting your programme with the AI Coach.',
ARRAY['workout compliance', 'workout target', 'sessions per week', 'workout goal'], 7),
...
ARRAY['workout history', 'past workouts', 'exercise history', 'session log'], 8),
...
You start a session by selecting a plan (or building one on the fly), then log your actual performance during the session. The session is saved to your history when you tap Complete Workout.',
ARRAY['workout plan', 'workout session', 'difference', 'template', 'routine'], 9),
...
ARRAY['progressive overload', 'increase weight', 'strength progress', 'personal record', 'PR'], 10);

-- ---- GOALS & PROGRESS (cat-04) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-04-0000-0000-000000000004',
...
4. Choose your activity level (how many days per week you exercise).
5. Set your target weight and target body fat % if desired.
6. Tap Save Goals.

YFIT will calculate your daily calorie and macro targets automatically.',
ARRAY['set goals', 'fitness goals', 'target weight', 'goal setting', 'objectives'], 1),
...
Recomposition is slower than pure fat loss or pure muscle gain, but the results are more balanced. The scale may not move much, but your body composition will change — track measurements and progress photos for the best picture of your results.',
ARRAY['body recomposition', 'recomp', 'lose fat gain muscle', 'body composition'], 2),
...
Your weight and body fat history are shown as charts on the Progress page, alongside your BMI trend. The charts show your starting point, current value, and goal (if set) so you can see how far you''ve come.',
ARRAY['weight tracking', 'body fat', 'log weight', 'weigh in', 'BMI'], 3),
...
Your measurements are shown in the Body Recomp tab with direction-aware progress bars — reducing measurements (waist, hips) show progress as they decrease toward your goal, while building measurements (biceps, neck, thighs) show progress as they increase.',
ARRAY['body measurements', 'waist', 'hips', 'biceps', 'measurements', 'tape measure'], 4),
...
ARRAY['progress page', 'charts', 'trends', 'progress tracking', 'history'], 5),

('cat-04-0000-0000-000000000004',
'How does the activity level setting affect my calorie target?',
'The activity level you select in Goals applies a multiplier to your BMR (Basal Metabolic Rate) to calculate your TDEE (Total Daily Energy Expenditure):
...
These are fixed brackets — choosing "Moderate (3-5 days)" applies 1.55 regardless of whether you train 3 or 5 days that week. The setting only affects your calorie target calculation; it does not change any other feature in the app. Update it if your training frequency changes significantly.',
ARRAY['activity level', 'calorie multiplier', 'TDEE', 'exercise frequency', 'sedentary', 'moderate', 'active'], 6),
...
The streak is shown on your Dashboard with a 🔥 icon. Milestones:
• 1-2 days: "Good start!"
• 3-6 days: "Keep it up!"
• 7+ days: "On fire! 🔥"

Building a logging streak is one of the most effective habits for long-term fitness success — consistency beats perfection every time.',
ARRAY['streak', 'day streak', 'consistency', 'habit', 'logging streak'], 7),
...
Your goals appear in the Body Recomp tab as target lines on the progress bars and charts. The app automatically knows which direction is "progress" for each measurement — reducing for waist/hips, increasing for biceps/neck/thighs.',
ARRAY['measurement goals', 'body goals', 'waist goal', 'bicep goal', 'target measurements'], 8),
...
ARRAY['calorie accuracy', 'macro accuracy', 'calculation', 'metabolism', 'adjust calories'], 9),
...
The forecast updates as you log more data. The more consistently you log, the more accurate the predictions become.',
ARRAY['predictions', 'forecast', 'timeline', 'body composition forecast', 'goal date'], 10);

-- ---- MEDICATIONS & HEALTH (cat-05) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-05-0000-0000-000000000005',
...
Your medication will appear on the Medications page with its schedule. You can mark doses as taken by tapping the checkmark next to each dose.',
ARRAY['add medication', 'medication setup', 'drug', 'prescription', 'dosage'], 1),
...
ARRAY['medication reminder', 'reminder', 'notification', 'dose reminder', 'alert'], 2),
...
• Any other health product with a dosage schedule

Simply add it the same way as a medication, using the supplement name and your dosage.',
ARRAY['supplements', 'vitamins', 'creatine', 'protein powder', 'omega-3', 'track supplements'], 3),
...
The dose will be marked as taken and the time recorded. You can also mark a dose as skipped if you intentionally did not take it. Your adherence history is tracked over time.',
ARRAY['mark taken', 'dose taken', 'medication log', 'adherence', 'check off'], 4),
...
You will see a calendar view showing which doses were taken, skipped, or missed over the past 30 days. This is useful for tracking adherence and identifying patterns.',
ARRAY['medication history', 'adherence history', 'dose history', 'medication log'], 5),
...
ARRAY['edit medication', 'delete medication', 'remove medication', 'change dosage'], 6),
...
ARRAY['medical advice', 'doctor', 'medical disclaimer', 'health advice', 'prescription'], 7),
...
ARRAY['medication schedule', 'days of week', 'every other day', 'weekly', 'custom schedule'], 8),
...
• Steps — daily step count from phone sensors or manual entry
• Water intake — daily hydration tracking
• Sleep — hours of sleep per night
• Mood/energy — optional daily check-in

All metrics are shown in the Progress page with historical charts.',
ARRAY['health metrics', 'tracking', 'BMI', 'body fat', 'sleep', 'steps', 'water'], 9),
...
3. Enter your step count for the day, or if your phone has a step counter, it may sync automatically.
4. Tap Save.
...
ARRAY['steps', 'step count', 'pedometer', 'daily steps', 'walking'], 10);

-- ---- AI COACH (cat-06) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-06-0000-0000-000000000006',
...
The AI Coach has access to your logged data (with your permission) to give personalised advice based on your actual progress.',
ARRAY['AI coach', 'what can AI do', 'coach features', 'personal trainer', 'nutrition advice'], 1),
...
ARRAY['start chat', 'AI conversation', 'how to use AI coach', 'chat'], 2),
...
ARRAY['AI memory', 'conversation history', 'remember', 'context', 'previous chat'], 3),
...
However, the AI Coach is not a licensed personal trainer, registered dietitian, or medical professional. Its advice should be treated as a starting point, not a definitive prescription. Always:
...
If the AI gives advice that seems unsafe or inappropriate, please report it using the feedback button.',
ARRAY['AI safety', 'AI advice', 'reliable', 'trust AI', 'disclaimer'], 4),

('cat-06-0000-0000-000000000006',
'What is the FAQ tab in the AI Coach section?',
'The FAQ tab (this page!) contains a searchable library of common questions and answers about using YFIT. It covers all major features and is organised into 9 categories.
...
ARRAY['FAQ', 'help articles', 'knowledge base', 'support', 'FAQ tab'], 5),
...
The AI will generate a structured programme with exercises, sets, reps, and progression guidelines. You can then create this as a plan in the Fitness section.',
ARRAY['workout plan', 'AI workout', 'create programme', 'personalised plan', 'training plan'], 6),
...
• Your cooking skill level and time available
...
ARRAY['meal plan', 'AI meal planning', 'diet plan', 'food suggestions', 'meal ideas'], 7),

('cat-06-0000-0000-000000000006',
'Why is the AI Coach slow to respond sometimes?',
'The AI Coach response time depends on:

• Your internet connection speed
• Server load at the time of your request
• The complexity of your question (longer, more detailed questions take slightly longer)
...
ARRAY['AI slow', 'response time', 'AI not responding', 'loading', 'delay'], 8),
...
Your feedback helps improve the AI Coach for all users. We review all feedback reports.',
ARRAY['AI feedback', 'report AI', 'bad response', 'incorrect answer', 'improve AI'], 9),
...
This data is sent to the AI model only to generate your response and is not stored by the AI provider or used to train future models. Your conversation history is stored in your YFIT account for the duration of the session only.

You can ask the AI Coach general questions without it accessing your personal data — just ask without mentioning your specific stats.',
ARRAY['AI data', 'privacy', 'personal data', 'AI training', 'data usage'], 10);

-- ---- ACCOUNT SETTINGS (cat-07) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-07-0000-0000-000000000007',
'How do I change my email address or password?',
'To change your email or password:

1. Go to Account Settings (⚙️) in the navigation bar.
2. Tap Edit Profile.
...
For security, you will be asked to re-authenticate when changing your email or password.',
ARRAY['change email', 'change password', 'update email', 'reset password', 'account security'], 1),
...
ARRAY['profile photo', 'avatar', 'profile picture', 'change photo'], 2),
...
ARRAY['notifications', 'reminders', 'push notifications', 'alerts', 'turn off notifications'], 3),
...
ARRAY['display name', 'username', 'name', 'change name'], 4),
...
In the meantime, you can view all your historical data in the Progress page and take screenshots for your records. If you need a data export urgently, use the feedback button to submit a request.',
ARRAY['export data', 'download data', 'data export', 'CSV', 'backup'], 5),
...
This permanently deletes the selected data. Your account, goals, and settings are not affected unless you also reset those.',
ARRAY['reset data', 'start fresh', 'clear data', 'delete logs', 'wipe data'], 6),
...
Currently, step counts can be entered manually in the Daily Tracker. If you use a fitness tracker, you can manually transfer your daily step count.

Use the feedback button to vote for specific integrations — your requests help prioritise our development roadmap.',
ARRAY['integrations', 'Apple Health', 'Google Fit', 'Fitbit', 'connect apps', 'sync'], 7),
...
ARRAY['privacy settings', 'data privacy', 'account privacy', 'privacy policy'], 8),
...
ARRAY['uninstall', 'reinstall', 'data loss', 'cloud storage', 'delete app'], 9),
...
2. For urgent issues, email support directly.

The feedback button is the fastest way to reach us — reports are reviewed daily. Include as much detail as possible about the issue, including what page you were on and what you were trying to do.',
ARRAY['contact support', 'help', 'support', 'bug report', 'customer service'], 10);

-- ---- SUBSCRIPTION & BILLING (cat-08) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-08-0000-0000-000000000008',
...
ARRAY['subscription', 'pricing', 'plans', 'cost', 'price', 'pro', 'free'], 1),
...
ARRAY['upgrade', 'pro plan', 'subscribe', 'payment', 'upgrade to pro'], 2),
...
Your Pro features will remain active until the end of your current billing period. After that, your account will revert to the free Starter plan. You will not be charged again.',
ARRAY['cancel subscription', 'cancel', 'unsubscribe', 'stop payment', 'end subscription'], 3),
...
ARRAY['refund', 'money back', 'refund policy', 'cancel and refund'], 4),
...
ARRAY['downgrade', 'free plan', 'data after downgrade', 'lose access'], 5),
...
ARRAY['free trial', 'trial', 'try pro', 'test pro'], 6),
...
ARRAY['payment method', 'credit card', 'update card', 'billing details'], 7),
...
If you are a student or have a specific pricing need, contact support using the feedback button and we will see what we can do.',
ARRAY['discount', 'student discount', 'family plan', 'group plan', 'cheaper'], 8),
...
The Lifetime plan is ideal if you plan to use YFIT long-term and want to avoid ongoing subscription costs.',
ARRAY['lifetime', 'one time payment', 'lifetime access', 'founders', 'permanent'], 9),
...
YFIT staff cannot see your full card number. Only the last 4 digits are visible for identification purposes.',
ARRAY['payment security', 'card security', 'PCI', 'secure payment', 'safe payment'], 10);

-- ---- TROUBLESHOOTING (cat-09) ----
INSERT INTO faq_articles (category_id, question, answer, keywords, display_order) VALUES

('cat-09-0000-0000-000000000009',
'The app shows a spinning loading screen and won''t open. What do I do?',
'A persistent spinning screen is usually caused by a stale cached version of the app conflicting with a new update. Here''s how to fix it:
...
ARRAY['spinning', 'loading', 'stuck', 'won''t open', 'spinning disk', 'loading screen', 'cache'], 1),

('cat-09-0000-0000-000000000009',
'The barcode scanner isn''t working. How do I fix it?',
...
If a product scans but shows "not found", the product may not be in the Open Food Facts database. Use Create Custom Food to add it manually.',
ARRAY['barcode scanner', 'scanner not working', 'camera permission', 'scan error', 'barcode error'], 2),

('cat-09-0000-0000-000000000009',
'My nutrition data isn''t saving. What should I check?',
...
If you continue to have saving issues, use the feedback button to report the problem with details of what food you were trying to log.',
ARRAY['not saving', 'data not saving', 'food not logging', 'save error', 'sync error'], 3),
...
The app loads fastest on repeat visits after the initial download, as assets are cached locally. The first open after a new update may be slightly slower as new files are downloaded.',
ARRAY['slow', 'slow app', 'performance', 'lag', 'speed up'], 4),
...
If you still cannot log in after resetting your password, use the feedback button (accessible without logging in) or email support directly.',
ARRAY['can''t login', 'login error', 'forgot password', 'password reset', 'sign in error'], 5),
...
If workouts are genuinely missing, use the feedback button to report the issue with the dates of the missing sessions. We can investigate your account data directly.',
ARRAY['workout missing', 'history gone', 'data missing', 'lost workouts', 'disappeared'], 6),
...
The AI Coach requires an active internet connection. If it consistently fails to respond, there may be a temporary service issue. Check back in a few minutes. If the problem persists for more than an hour, use the feedback button to report it.',
ARRAY['AI not working', 'AI not responding', 'coach error', 'AI down', 'chat not working'], 7),
...
If you use a fitness tracker or phone step counter, check your device''s health app for your step count and enter it manually in YFIT.',
ARRAY['steps not updating', 'step count wrong', 'steps not syncing', 'pedometer'], 8),
...
Bug reports are reviewed daily. The more detail you provide, the faster we can fix the issue. Thank you for helping improve YFIT!',
ARRAY['report bug', 'bug report', 'feedback', 'report issue', 'error report'], 9),

('cat-09-0000-0000-000000000009',
'The app updated and now something is broken. What should I do?',
'After an app update, occasionally a cached file can conflict with the new version. This is the most common cause of post-update issues.
...
If the problem persists after clearing cache, use the feedback button to report exactly what is broken. Include the page name and what action causes the issue.',
ARRAY['after update', 'update broke', 'new version broken', 'update issue', 'post update'], 10);
