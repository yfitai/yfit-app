...
export default function CustomFoodModal({ user, onSave, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.name || !form.calories) {
      alert(t('nutrition.pleaseEnterFoodNameAndCalories'))
      return
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-800">{t('nutrition.createCustomFood')}</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6">
          <div className="space-y-4">
            ...
            <div className="border-t border-gray-200 pt-4 mt-4">
              <h3 className="text-sm font-medium text-gray-700 mb-3">{t('nutrition.optionalNutrients')}</h3>
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50 flex gap-3">
          ...
          >
            {saving ? t('common.saving') : t('nutrition.saveCustomFood')}
          </button>
        </div>
      </div>
    </div>
