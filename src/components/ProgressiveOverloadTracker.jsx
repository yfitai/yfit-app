...
const ProgressiveOverloadTracker = ({ userId, exerciseId, exerciseName, onSuggestionApplied }) => {
  ...
  const getStrategyText = (strategy) => {
    const strategies = {
      ...
      'weight_progression': t('fitness.progressiveOverload'),
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-600">{t('fitness.weight')} (lbs)</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">
          ...
          {(progression.max_weight || progression.max_reps) && (
            <div className="mt-4 pt-4 border-t border-blue-200">
              <div className="text-xs text-gray-600 mb-2 font-medium">{t('fitness.personalBest')}</div>
              <div className="flex gap-4 text-sm">
                {progression.max_weight && (
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-600">max {t('fitness.weight')}</span>
                  </div>
                )}
                {progression.max_reps && (
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-600">max {t('fitness.reps')}</span>
                  </div>
                )}
              </div>
              {progression.pr_date && (
          ...
          <div className="mt-3 text-xs text-gray-600">
            <span className="font-medium">{progression.total_workouts || 0}</span> {t('fitness.workoutHistory')}
      ...
      {suggestion && (
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-gray-900">{t('fitness.progressiveOverload')} Suggestion</h3>
          </div>
      ...
      {showCelebration && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-white rounded-lg p-8 max-w-md mx-4 text-center animate-scaleIn">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('progress.milestoneReached')}</h2>
