        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-600">{t('fitness.weightLbs', 'Weight (lbs)')}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">
          ...
          {(progression.max_weight || progression.max_reps) && (
            <div className="mt-4 pt-4 border-t border-blue-200">
              <div className="text-xs text-gray-600 mb-2 font-medium">{t('fitness.personalRecords', 'Personal Records')}</div>
      ...
      {suggestion && (
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-gray-900">{t('fitness.progressiveOverloadSuggestion', 'Progressive Overload Suggestion')}</h3>
          </div>
        ...
        <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
          ...
          {suggestion && (
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <div className="text-sm text-gray-700 mb-2">{t('fitness.recommendedStartingPoint', 'Recommended starting point:')}</div>
      ...
      {progression && progression.needs_deload && (
        <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-semibold text-gray-900">{t('fitness.deloadWeek', 'Time for a Deload Week')}</h3>
          </div>
      ...
      {showCelebration && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-white rounded-lg p-8 max-w-md mx-4 text-center animate-scaleIn">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('fitness.newPersonalRecord', 'New Personal Record!')}</h2>
