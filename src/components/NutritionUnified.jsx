...
// Update: Fixed nutrition serving sizes calculation - Jan 28, 2026
 ...
 function NutritionUnified({ user }) {
    ...
    <div className="min-h-screen bg-gray-50 pb-8 overflow-x-hidden">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-4">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">{t('nutrition.mealPlanningTitle')}</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-2 pb-1">
              ...
              >
                ...
                <span className="text-sm sm:text-base">{t('nutrition.dailyTracker')}</span>
              </button>
              ...
              >
                ...
                <span className="text-sm sm:text-base">{t('nutrition.weeklyPlanner')}</span>
              </button>
              ...
              >
                ...
                <span className="text-sm sm:text-base">{t('nutrition.templates')}</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div>
            <div className="mb-4 bg-teal-50 border border-teal-200 rounded-lg p-4">
              <p className="text-sm text-teal-800">
                <strong>💡 {t('common.tip')}:</strong> {t('nutrition.dailyTrackerTip')}
              </p>
            </div>
        ...
        {activeTab === 'weekly' && (
          <div>
            <div className="mb-4 bg-teal-50 border border-teal-200 rounded-lg p-4">
              <p className="text-sm text-teal-800">
                <strong>💡 {t('common.tip')}:</strong> {t('nutrition.weeklyPlannerTip')}
              </p>
            </div>
  ...
  <div>
    <div className="mb-4 bg-teal-50 border border-teal-200 rounded-lg p-4">
      <p className="text-sm text-teal-800">
        <strong>💡 {t('common.tip')}:</strong> {t('nutrition.templatesTip')}
      </p>
    </div>
<MealTemplates 
